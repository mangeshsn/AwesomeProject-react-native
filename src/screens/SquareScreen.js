...
export default class SquareScreen extends React.Component {
  ...
  setColor = (color, change) => {
    switch (color) {
      case 'red':
        this.props.red + this.COLOR_INCREMENT > 255 || this.props.red < 0
          ? null
          : this.setState({
              red: this.state.red + change,
            });
        break;
      case 'green':
        this.props.green + this.COLOR_INCREMENT > 255 || this.props.green < 0
          ? null
          : this.setState({
              green: this.state.green + change,
            });
        break;
      case 'blue':
        this.props.blue + this.COLOR_INCREMENT > 255 || this.props.blue < 0
          ? null
          : this.setState({
              blue: this.state.blue + change,
            });
        break;
